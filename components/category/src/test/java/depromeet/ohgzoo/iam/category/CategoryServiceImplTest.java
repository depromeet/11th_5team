...
class CategoryServiceImplTest {
    ...
    public void categoryList_returnsCategoryResponse() throws Exception {
        ...
        assertThat(result.getNegative().get(0).getDescription()).isEqualTo("후회해요");
        assertThat(result.getNegative().get(1).getDescription()).isEqualTo("슬퍼요");
        assertThat(result.getNegative().get(2).getDescription()).isEqualTo("실망했어요");
        assertThat(result.getNegative().get(3).getDescription()).isEqualTo("무기력해요");
        assertThat(result.getNegative().get(4).getDescription()).isEqualTo("불안해요");
        assertThat(result.getNegative().get(5).getDescription()).isEqualTo("짜증나요");
    ...
    public void firstCategoryList_returnsCategoryResponse() throws Exception {
        ...
        assertThat(result.get(0).getDescription()).isEqualTo("후회해요");
        assertThat(result.get(1).getDescription()).isEqualTo("슬퍼요");
        assertThat(result.get(2).getDescription()).isEqualTo("실망했어요");
        assertThat(result.get(3).getDescription()).isEqualTo("무기력해요");
        assertThat(result.get(4).getDescription()).isEqualTo("불안해요");
        assertThat(result.get(5).getDescription()).isEqualTo("짜증나요");
    ...
    public void secondCategoryList_returnsCategoryResponse() throws Exception {
        ...
        assertThat(result.get(5).getDescription()).isEqualTo("후회해요");
        assertThat(result.get(6).getDescription()).isEqualTo("슬퍼요");
        assertThat(result.get(7).getDescription()).isEqualTo("실망했어요");
        assertThat(result.get(8).getDescription()).isEqualTo("무기력해요");
        assertThat(result.get(9).getDescription()).isEqualTo("불안해요");
        assertThat(result.get(10).getDescription()).isEqualTo("짜증나요");
