...
(folder_item_id, created_at, updated_at, content, disclosure, first_category, member_id, post_id, second_category, tags,
 folder_id)
values ('1', CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), 'post content', 1, 'UPSET', 1, '1', 'ANGRY', 'tag1,tag2', 1);

insert into folder_item
(folder_item_id, created_at, updated_at, content, disclosure, first_category, member_id, post_id, second_category, tags,
 folder_id)
values ('2', CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), 'post content', 1, 'UPSET', 1, '2', 'ANGRY', 'tag1,tag2', 1);

insert into folder_item
(folder_item_id, created_at, updated_at, content, disclosure, first_category, member_id, post_id, second_category, tags,
 folder_id)
values ('3', CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), 'post content', 1, 'UPSET', 1, '3', 'ANGRY', 'tag1,tag2', 1);